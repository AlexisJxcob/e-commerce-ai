...
class AsistenteIAServiceTest {
    ...
    @BeforeEach
    void setUp() {
        asistenteIAService = new AsistenteIAService(openRouterService, productoService);
    }
    ...
    void buscarRecomendacion_combinaTerminosYBuscaProductos() {
        ...
        when(openRouterService.analizarConsulta("fuga en tuberia")).thenReturn(sugerencia);
        ...
        verify(openRouterService).analizarConsulta("fuga en tuberia");
    }
