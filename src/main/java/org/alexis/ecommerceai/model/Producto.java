...
public class Producto {
    ...
    // Aquí vive la magia del "coso": lenguaje informal, modismos o términos populares
    ...
    // Cambia 1536 a las dimensiones de tu modelo de embedding (ej. 1536 para OpenAI, 768 para Ollama/nomic-embed-text)
